...
class ProgressScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Progress Indicatros'),
      ),
    ...
    return const Center(
      child: Column(
        children: [
          ...
          Text('Circular and Linear Progress Indicator Controled'),
          SizedBox(
            height: 10,
          ),
        ...
        return  Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Expanded(child: LinearProgressIndicator(value: progressValue,)),//Expanded takes all the space that the father widget gives you
